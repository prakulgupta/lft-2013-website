            ...
            <div class="circleblockleft">
                <div id="blockleftL">
                    <asp:Panel ID="Panel12" runat="server">
                        <a href="NEWMEMBERS/Delhi.aspx" target="_self">
                            <h1>MEMBERS
                            </h1>
                            <div align="center">
                ...
                <div id="blockrightR">
                    <asp:Panel ID="Panel14" runat="server">
                        <a href="lftclub.aspx" target="_self">
                            ...
                            <div align="center">
                                <img src="images/lftclub.png" alt="" style="padding: 10px" />
                            </div>
                        </a>
      ...
      <div class="clear">
        ...
        <div class="container">
            ...
            <div class="contentleft">
                <div class="firstcolumn">
                    <div class="contentleftpos" style="height: 380px;">
                        ...
                        <div class="griddiv">
                        <img id="Img1" src="images/lom/saurabh1.jpg" style="height: 120px; width: 120px; margin-left: 5px; margin-top: 20px;">
                        <asp:Panel ID="Panel15" runat="server" CssClass="gridpanel">
                            <h4>Saurabh Chowdhury</h4>
                            <br />
                            <h5>He is our Core Team Member from Deshbandhu College, Delhi University. He is a part of our creative team. </h5>
                        </asp:Panel>    
                ...
                <div class="secondcolumn">
                    <div class="contentleftpos" style="height: 380px;">
                        <a href="https://www.facebook.com/photo.php?fbid=10151747347212920&set=a.153049457919.113784.93836892919&type=1&theater" target="_blank">
                        <center><img id="Img3" src="images/grid/GDs.png" style="width:250px;margin-left: 5px; margin-top: 20px;" ></center>
                            </a>
                        <div class="griddiv">
                            <h4 style="text-align: center;">Topic of the week!</h4>
                            
                            <h5 style="text-align: center;">"Wildlife Conservation and You"</h5>
                            <br />
                            <p class="para">Tell us what YOU think your role could be as far as wildlife conservation goes. Do we really need it? Or are we just being paranoid? Share your views with us @LEADERS FOR TOMORROW Debates at Facebook.</p>
            ...
            <div class="contentright">
                <div class="fb-like-box" data-href="https://www.facebook.com/LeadersForTomorrow" data-width="410" data-height="638" data-show-faces="true" data-stream="true" data-show-border="true" data-header="true"></div>
            </div>
            <div class="clear">
            </div>
            <!--end -->
