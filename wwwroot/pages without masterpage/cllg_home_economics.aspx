<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cllg_home_economics.aspx.cs"
    Inherits="cllg_home_economics" %>
...
<body>
    ...
    <div class="container">
        <ul id="q_nav">
            ...
            <li><a href="#">/</a></li>
            <li><a href="#" class="active">LFT Institue of Home Economics</a></li>
        </ul>
        <div class="clear">
        </div>
        <div class="divider1">
        ...
        <div class="container_12">
            <div class="main_heading">
                <h2>
                    Leaders for Tomorrow, <font class="pink">in</font> Institue of Home Economics Delhi University</h2>
            </div>
            <div id="main">
                <ul id="filtering-nav">
