...
<body>
    ...
    <div class="container">
        <ul id="q_nav">
            ...
            <li><a href="#">/</a></li>
            <li><a href="#" class="active">Zakir Husain Delhi College, University of Delhi </a>
            </li>
        </ul>
        <div class="clear">
        </div>
        ...
        <div class="container_12">
            <div class="main_heading">
                <h2>
                    Leaders for Tomorrow, <font class="pink">in</font> Zakir Husain Delhi College, University
                    of Delhi
                </h2>
            </div>
                ...
                <div class="wrap_page columns_2">
                    ...
                    <div class="portfolio_box C">
                        <div class="wrap_image">
                            <img src="college_image/zakhir/adar/1.jpg" alt="Big Image" />
                            <a class="over_image" rel="fancyzoom" href="college_image/zakhir/adar/1.jpg" title="Single Image">
                                view image</a>
                        </div>
                    </div>
                    <div class="portfolio_box C">
                        <div class="wrap_image">
                            <img src="college_image/zakhir/adar/2.jpg" alt="Big Image" />
                            <a class="over_image" rel="fancyzoom" href="college_image/zakhir/adar/2.jpg" title="Single Image">
                                view image</a>
                        </div>
                    </div>
                    <div class="portfolio_box C">
                        <div class="wrap_image">
                            <img src="college_image/zakhir/adar/3.jpg" alt="Motion" />
                            <a class="over_image" rel="fancyzoom" href="college_image/zakhir/adar/3.jpg">view image</a>
                        </div>
                    </div>
                    <div class="portfolio_box C">
                        <div class="wrap_image">
                            <img src="college_image/zakhir/adar/4.jpg" alt="Motion" />
                            <a class="over_image" rel="fancyzoom" href="college_image/zakhir/adar/4.jpg">view image</a>
                        </div>
                    </div>
                    <div class="portfolio_box C">
                        <div class="wrap_image">
                            <img src="college_image/zakhir/adar/5.jpg" alt="Motion" />
                            <a class="over_image" rel="fancyzoom" href="college_image/zakhir/adar/5.jpg">view image</a>
                        </div>
                    </div>
                    <div class="portfolio_box C">
                        <div class="wrap_image">
                            <img src="college_image/zakhir/adar/6.jpg" alt="Motion" />
                            <a class="over_image" rel="fancyzoom" href="college_image/zakhir/adar/6.jpg">view image</a>
                        </div>
                    </div>
                </div>
            </div>
