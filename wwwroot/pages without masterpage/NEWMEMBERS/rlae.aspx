<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rlae.aspx.cs" Inherits="NEWMEMBERS_rlae" %>
...
<body>
    ...
    <div class="container">
        <ul id="q_nav">
            ...
            <li><a href="#">/</a></li>
            <li><a href="#" class="active">RLAE</a></li>
        </ul>
        <div class="clear">
        </div>
        <div class="divider1">
        ...
        <div class="container_12">
            <div class="main_heading">
                <h2>
                    New members of LFT <font class="pink">in</font> RLAE College</h2>
            </div>
            <div id="main">
                <!--<ul id="filtering-nav">
                ...
                <div class="wrap_page columns_2">
                    ...
                    <div class="portfolio_box 1">
                        <div class="wrap_image">
                            <img src="images/rlae/1.jpg" alt="Big Image" />
                            <a class="over_image" rel="fancyzoom" href="images/rlae/1.jpg" title="Single Image">
                                view image</a>
                        </div>
                    </div>
                    <div class="portfolio_box 1">
                        <div class="wrap_image">
                            <img src="images/rlae/2.jpg" alt="Big Image" />
                            <a class="over_image" rel="fancyzoom" href="images/rlae/2.jpg" title="Single Image">
                                view image</a>
                        </div>
                    </div>
                    <div class="portfolio_box 1">
                        <div class="wrap_image">
                            <img src="images/rlae/3.jpg" alt="Big Image" />
                            <a class="over_image" rel="fancyzoom" href="images/rlae/3.jpg" title="Single Image">
                                view image</a>
                        </div>
                    </div>
                    <div class="portfolio_box 1">
                        <div class="wrap_image">
                            <img src="images/rlae/4.jpg" alt="Big Image" />
                            <a class="over_image" rel="fancyzoom" href="images/rlae/4.jpg" title="Single Image">
                                view image</a>
                        </div>
                    </div>
                    <div class="portfolio_box 2">
                        <div class="wrap_image">
                            <img src="images/rlae/Day2/1.jpg" alt="Big Image" />
                            <a class="over_image" rel="fancyzoom" href="images/rlae/Day2/1.jpg" title="Single Image">
                                view image</a>
                        </div>
                    </div>
                    <div class="portfolio_box 2">
                        <div class="wrap_image">
                            <img src="images/rlae/Day2/2.jpg" alt="Big Image" />
                            <a class="over_image" rel="fancyzoom" href="images/rlae/Day2/2.jpg" title="Single Image">
                                view image</a>
                        </div>
                    </div>
                    <div class="portfolio_box 2">
                        <div class="wrap_image">
                            <img src="images/rlae/Day2/3.jpg" alt="Big Image" />
                            <a class="over_image" rel="fancyzoom" href="images/rlae/Day2/3.jpg" title="Single Image">
                                view image</a>
                        </div>
                    </div>
