<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shyamlal.aspx.cs" Inherits="NEWMEMBERS_shyamlal" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <ul id="q_nav">
                ...
                <li><a href="#">/</a></li>
                <li><a href="#" class="active">Shayam Lal College</a></li>
            </ul>
            <div class="clear">
            </div>
            <div class="divider1">
            ...
            <div class="container_12">
                <div class="main_heading">
                    <h2>New members of LFT <font class="pink">in</font> Shayam Lal College</h2>
                </div>
                <div id="main">
                    <!--<ul id="filtering-nav">
                    ...
                    <div class="wrap_page columns_2">
                        ...
                        <div class="portfolio_box 1">
                            <div class="wrap_image">
                                <img src="images/shyam/1.jpg" alt="Big Image" />
                                <a class="over_image" rel="fancyzoom" href="images/shyam/1.jpg" title="Single Image">view image</a>
                            </div>
                        </div>
                        <div class="portfolio_box 1">
                            <div class="wrap_image">
                                <img src="images/shyam/2.jpg" alt="Big Image" />
                                <a class="over_image" rel="fancyzoom" href="images/shyam/2.jpg" title="Single Image">view image</a>
                            </div>
                        </div>
                        </div>
                    </div>
