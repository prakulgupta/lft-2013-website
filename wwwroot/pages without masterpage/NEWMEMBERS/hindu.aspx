<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hindu.aspx.cs" Inherits="hindu" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <ul id="q_nav">
                ...
                <li><a href="#">/</a></li>
                <li><a href="#" class="active">Hindu College, University of Delhi</a></li>
            </ul>
            <div class="clear">
            </div>
            <div class="divider1">
            ...
            <div class="container_12">
                <div class="main_heading">
                    <h2>New members of LFT <font class="pink">in</font> Hindu College, University of Delhi</h2>
                </div>
                <div id="main">
                    <!--<ul id="filtering-nav">
                    ...
                    <!--    <div class="portfolio_box 1">
                            <div class="wrap_image">
                                <img src="images/hindu/1.jpg" alt="Big Image" />
                                <a class="over_image" rel="fancyzoom" href="images/hindu/1.jpg" title="Single Image">view image</a>
                            </div>
                        </div>
                        -->
                           ...
                           <div class="portfolio_box 1">
                            <div class="wrap_image">
                                <img src="images/hindu/2.jpg" alt="Big Image" />
                                <a class="over_image" rel="fancyzoom" href="images/hindu/2.jpg" title="Single Image">view image</a>
                            </div>
                        </div>
                           <div class="portfolio_box 1">
                            <div class="wrap_image">
                                <img src="images/hindu/3.jpg" alt="Big Image" />
                                <a class="over_image" rel="fancyzoom" href="images/hindu/3.jpg" title="Single Image">view image</a>
                            </div>
                        </div>
                           <div class="portfolio_box 1">
                            <div class="wrap_image">
                                <img src="images/hindu/4.jpg" alt="Big Image" />
                                <a class="over_image" rel="fancyzoom" href="images/hindu/4.jpg" title="Single Image">view image</a>
                            </div>
                        </div>
                           <div class="portfolio_box 1">
                            <div class="wrap_image">
                                <img src="images/hindu/5.jpg" alt="Big Image" />
                                <a class="over_image" rel="fancyzoom" href="images/hindu/5.jpg" title="Single Image">view image</a>
                            </div>
                        </div>
