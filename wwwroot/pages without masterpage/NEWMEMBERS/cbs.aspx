<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cbs.aspx.cs" Inherits="NEWMEMBERS_cbs" %>
        ...
        <div class="container">
            ...
            <div class="container_12">
                <div class="main_heading">
                    <h2>New members of LFT <font class="pink">in</font> CBS</h2>
                </div>
                <div id="main">
                    <!--<ul id="filtering-nav">
                    ...
                    <div class="wrap_page columns_2">
                        <div class="portfolio_box 1">
                            <div class="wrap_image">
                                <img src="images/cbs/1.jpg" alt="Big Image" />
                                <a class="over_image" rel="fancyzoom" href="images/cbs/1.jpg" title="Single Image">view image</a>
                            </div>
                        </div>
                        <div class="portfolio_box 1">
                            <div class="wrap_image">
                                <img src="images/cbs/2.jpg" alt="Big Image" />
                                <a class="over_image" rel="fancyzoom" href="images/cbs/2.jpg" title="Single Image">view image</a>
                            </div>
                        </div>
                        <div class="portfolio_box 1">
                            <div class="wrap_image">
                                <img src="images/cbs/3.jpg" alt="Big Image" />
                                <a class="over_image" rel="fancyzoom" href="images/cbs/3.jpg" title="Single Image">view image</a>
                            </div>
                        </div>
                        <div class="portfolio_box 1">
                            <div class="wrap_image">
                                <img src="images/cbs/4.jpg" alt="Big Image" />
                                <a class="over_image" rel="fancyzoom" href="images/cbs/4.jpg" title="Single Image">view image</a>
                            </div>
                        </div>
                        <div class="portfolio_box 2">
                            <div class="wrap_image">
                                <img src="images/cbs/Day2/1.jpg" alt="Big Image" />
                                <a class="over_image" rel="fancyzoom" href="images/cbs/Day2/1.jpg" title="Single Image">view image</a>
                            </div>
                        </div>
                        <div class="portfolio_box 2">
                            <div class="wrap_image">
                                <img src="images/cbs/Day2/2.jpg" alt="Big Image" />
                                <a class="over_image" rel="fancyzoom" href="images/cbs/Day2/2.jpg" title="Single Image">view image</a>
                            </div>
                        </div>
                    </div>
                </div>
