<%@ Page Language="C#" AutoEventWireup="true" CodeFile="daulatram.aspx.cs" Inherits="daulatram" %>
...
<body>
    ...
    <div class="container">
        <ul id="q_nav">
            ...
            <li><a href="#">/</a></li>
            <li><a href="#" class="active">Daulat Ram College, Delhi University </a></li>
        </ul>
        <div class="clear">
        </div>
        <div class="divider1">
        ...
        <div class="container_12">
            <div class="main_heading">
                <h2>
                    Leaders for Tomorrow, <font class="pink">in</font> Daulat Ram College Delhi University</h2>
            </div>
            <div id="main">
                <ul id="filtering-nav">
                ...
                <div class="wrap_page columns_2">
                    ...
                    <div class="portfolio_box C">
                        <div class="wrap_image">
                            <img src="college_image/daulatram/adapt/1.jpg" alt="Big Image" />
                            <a class="over_image" rel="fancyzoom" href="college_image/daulatram/adapt/1.jpg"
                                title="Single Image">view image</a>
                        </div>
                    </div>
                    <div class="portfolio_box C">
                        <div class="wrap_image">
                            <img src="college_image/daulatram/adapt/2.jpg" alt="Big Image" />
                            <a class="over_image" rel="fancyzoom" href="college_image/daulatram/adapt/2.jpg"
                                title="Single Image">view image</a>
                        </div>
                    </div>
                    <div class="portfolio_box C">
                        <div class="wrap_image">
                            <img src="college_image/daulatram/adapt/3.jpg" alt="Motion" />
                            <a class="over_image" rel="fancyzoom" href="college_image/daulatram/adapt/3.jpg">view
                                image</a>
                        </div>
                    </div>
                    <div class="portfolio_box C">
                        <div class="wrap_image">
                            <img src="college_image/daulatram/adapt/4.jpg" alt="Big Image" />
                            <a class="over_image" rel="fancyzoom" href="college_image/daulatram/adapt/4.jpg"
                                title="Single Image">view image</a>
                        </div>
                    </div>
                    <div class="portfolio_box C">
                        <div class="wrap_image">
                            <img src="college_image/daulatram/adapt/5.jpg" alt="Big Image" />
                            <a class="over_image" rel="fancyzoom" href="college_image/daulatram/adapt/5.jpg"
                                title="Single Image">view image</a>
                        </div>
                    </div>
                </div>
