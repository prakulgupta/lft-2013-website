    ...
    <div class="container">
        ...
        <div class="container_12">
            <div class="main_heading">
                <h2>
                    Leaders for Tomorrow <font class="pink">in pictures</font>.</h2>
            </div>
            <div id="main">
                <ul id="filtering-nav">
                    <li><a class="interactive" href="#interactive">Summit</a></li>
                    <li><a class="identity" href="#identity">IYM</a></li>
                    <li><a class="motion" href="#motion">SDP</a></li>
                    <li><a class="print" href="#print">LFT in the News</a></li>
                    <li><a class="photography" href="#photography">AFC</a></li>
                ...
                <div class="wrap_page columns_1">
                    ...
                    <div class="portfolio_box interactive">
                        <div class="wrap_image">
                            <img src="gallery/1.jpg" alt="Big Image" />
                        </div>
                        <!-- end wrap_image div -->
                    </div>
                    ...
                    <div class="portfolio_box identity">
                        <div class="wrap_image">
                            <img src="gallery/2.jpg" alt="Big Image" />
                        </div>
                        <!-- end wrap_image div -->
                    </div>
                    <!-- end portfolio_box div -->
                    <div class="portfolio_box motion nomarginright">
                        <div class="wrap_image">
                            <img src="gallery/5.jpg" alt="Big Image" />
                        </div>
                        <!-- end wrap_image div -->
                    </div>
                    <!-- end portfolio_box div -->
                    <div class="portfolio_box print">
                        <div class="wrap_image">
                            <img src="gallery/3.jpg" alt="Big Image" />
                        </div>
                        <!-- end wrap_image div -->
                    </div>
                    <!-- end portfolio_box div -->
                    <div class="portfolio_box photography">
                        <div class="wrap_image">
                            <img src="gallery/4.jpg" alt="Big Image" />
                        </div>
                        <!-- end wrap_image div -->
                    </div>
                    <!-- end portfolio_box div -->
                    <div class="portfolio_box motion nomarginright">
                        <div class="wrap_image">
                            <img src="gallery/6.jpg" alt="Big Image" /></div>
                    </div>
                </div>
            </div>
        </div>
